...
public class statusCOD {
    ...
    private void initFilterComboBox() {
        ...
        filterComboBox1.getItems().addAll("Необходима привязка выработки","Требуется геологическое описание","Требуется геомеханическое обоснование (указание)","Все данные внесены");
        ...
        filterComboBox1.setValue("Необходима привязка выработки");
